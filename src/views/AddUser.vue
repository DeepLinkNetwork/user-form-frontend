        ...
        <ValidationObserver v-slot="{ handleSubmit }">
            <form @submit.prevent="handleSubmit(onSubmit)">
                ...
                <div class="form-group">
                    ...
                    <ValidationProvider v-slot="{ errors }" name="Date of Birth" rules="required|dob18plus">
                        <datepicker
                            id="dob"
                            v-model="dob"
                ...
                <div class="form-group">
                    ...
                    <ValidationProvider v-slot="{ errors }" name="E-mail" rules="required|email|max:75">
                        <input
                            id="email"
                            v-model="email"
                            type="email"
                ...
                <div class="form-group">
                    ...
                    >
                        <input id="verifyResponse" v-model="recaptchaResponse" type="hidden">
                        <span class="error">{{ errors[0] }}</span>
                    </ValidationProvider>
                </div>
...
export default {
    ...
    methods: {
        ...
        onSubmit: function() {
            ...
            this.x64signature = Fingerprint2.x64hash128(this.userHash + "user-db-app");
